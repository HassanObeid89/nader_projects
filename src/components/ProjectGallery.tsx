...
export function ProjectGallery({
  ...
  return (
    <div className="space-y-4">
      <div className="relative mx-auto h-[min(48vh,420px)] w-full overflow-hidden bg-paper-deep sm:h-[min(52vh,480px)]">
        <ContainedImage
          key={images[active]}
          src={images[active]}
      ...
      {images.length > 1 && (
        <div className="flex gap-2.5 overflow-x-auto py-1 [-ms-overflow-style:none] [scrollbar-width:none] [&::-webkit-scrollbar]:hidden">
          {images.map((src, i) => {
            ...
            return (
              <button
                ...
                className={`relative h-14 w-[4.5rem] shrink-0 overflow-hidden bg-paper-deep transition sm:h-16 sm:w-24 ${
